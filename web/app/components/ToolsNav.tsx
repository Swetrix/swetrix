...
export const TOOLS = [
  ...
  },
  {
    ...
    description: 'Check if Google can index a page',
  ...
  },
  {
    ...
    description: 'Test crawler access for a specific path',
  ...
  },
  {
    ...
    description: 'Find 404s, redirects, and invalid links',
  ...
  },
  {
    ...
    description: 'Validate international SEO alternates',
    href: '/tools/hreflang-checker',
    icon: GlobeIcon,
  },
  {
    id: 'serp-snippet-preview',
    title: 'SERP Snippet Preview',
    description: 'Preview Google title and description snippets',
  ...
  },
  {
    ...
    description: 'Audit titles, headings, links, images, and schema',
    href: '/tools/on-page-seo-checker',
    icon: FileSearchIcon,
  },
  {
    id: 'image-seo-checker',
    title: 'Image SEO Checker',
    description: 'Audit alt text, dimensions, sizes, and formats',
    href: '/tools/image-seo-checker',
    icon: FileMagnifyingGlassIcon,
  },
  {
    id: 'internal-link-analyzer',
    title: 'Internal Link Analyzer',
    description: 'Inspect anchors, rel attributes, and link groups',
    href: '/tools/internal-link-analyzer',
    icon: LinkIcon,
  },
  {
    id: 'ai-search-llm-crawlability-checker',
    title: 'AI Crawlability Checker',
    description: 'Check AI crawler rules, llms.txt, and schema',
    href: '/tools/ai-search-llm-crawlability-checker',
    icon: RobotIcon,
  },
  {
    id: 'gsc-export-analyzer',
    title: 'GSC Export Analyzer',
    description: 'Find CTR gaps, quick wins, and cannibalization',
    href: '/tools/gsc-export-analyzer',
    icon: ChartLineUpIcon,
  },
  {
    id: 'http-status-bulk-checker',
    title: 'HTTP Status Bulk Checker',
    description: 'Check statuses and redirects for URL lists',
    href: '/tools/http-status-bulk-checker',
    icon: NetworkIcon,
  },
  {
    id: 'seo-migration-redirect-validator',
    title: 'Migration Redirect Validator',
    description: 'Validate old to new URL redirect mappings',
    href: '/tools/seo-migration-redirect-validator',
    icon: LinkBreakIcon,
  },
  {
