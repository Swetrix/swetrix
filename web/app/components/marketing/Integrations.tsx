...
const FEATURED_INTEGRATIONS: {
...
}[] = [
  {
    name: 'Angular',
    category: 'framework',
    href: 'https://docs.swetrix.com/angular-integration',
    icon: siAngular,
  ...
  },
  {
    name: 'Astro',
    category: 'framework',
    href: 'https://docs.swetrix.com/astro-integration',
    icon: siAstro,
  },
  {
    name: 'BigCommerce',
    category: 'cms',
    href: 'https://docs.swetrix.com/bigcommerce-integration',
    icon: siBigcommerce,
  ...
  },
  {
    name: 'Carrd',
    category: 'cms',
    href: 'https://docs.swetrix.com/carrd-integration',
    icon: siCarrd,
  },
  {
    name: 'Django',
    category: 'backend',
    href: 'https://docs.swetrix.com/django-integration',
    icon: siDjango,
  ...
  },
  {
    name: 'Docusaurus',
    category: 'framework',
    href: 'https://docs.swetrix.com/docusaurus-integration',
    icon: siDocusaurus,
  },
  {
    name: 'Drupal',
    category: 'cms',
    href: 'https://docs.swetrix.com/drupal-integration',
    icon: siDrupal,
  },
  {
    name: 'Flask',
    category: 'backend',
    href: 'https://docs.swetrix.com/flask-integration',
    icon: siFlask,
  },
  {
    name: 'Framer',
    category: 'cms',
    href: 'https://docs.swetrix.com/framer-integration',
    icon: siFramer,
  },
  {
    name: 'Gatsby',
    category: 'framework',
    href: 'https://docs.swetrix.com/gatsby-integration',
    icon: siGatsby,
  },
  {
    name: 'Ghost',
    category: 'cms',
    href: 'https://docs.swetrix.com/ghost-integration',
    icon: siGhost,
    iconClassName: 'dark:text-white',
  },
  {
    name: 'Search Console',
    category: 'google',
    href: 'https://docs.swetrix.com/integrations/google-search-console',
    customIcon: GoogleGIcon,
  },
  {
    name: 'GTM',
    category: 'google',
    href: 'https://docs.swetrix.com/gtm-integration',
    icon: siGoogletagmanager,
  },
  {
    name: 'Hugo',
    category: 'framework',
    href: 'https://docs.swetrix.com/hugo-integration',
    icon: siHugo,
  },
  {
    name: 'Jekyll',
    category: 'framework',
    href: 'https://docs.swetrix.com/jekyll-integration',
    icon: siJekyll,
  },
  {
    name: 'Laravel',
    category: 'backend',
    href: 'https://docs.swetrix.com/laravel-integration',
    icon: siLaravel,
  },
  {
    name: 'Next.js',
    category: 'framework',
    href: 'https://docs.swetrix.com/nextjs-integration',
    icon: siNextdotjs,
    iconClassName: 'dark:text-white',
  },
  {
    name: 'Nuxt',
    category: 'framework',
    href: 'https://docs.swetrix.com/nuxt-integration',
    icon: siNuxt,
  },
  {
    name: 'React',
    category: 'framework',
    href: 'https://docs.swetrix.com/react-integration',
    icon: siReact,
  },
  {
    name: 'Remix',
    category: 'framework',
    href: 'https://docs.swetrix.com/remix-integration',
    icon: siRemix,
    iconClassName: 'dark:text-white',
  },
  {
    name: 'Ruby on Rails',
    category: 'backend',
    href: 'https://docs.swetrix.com/ruby-on-rails-integration',
    icon: siRubyonrails,
  },
  {
    name: 'Shopify',
    category: 'cms',
    href: 'https://docs.swetrix.com/shopify-integration',
    icon: siShopify,
  },
  {
    name: 'Squarespace',
    category: 'cms',
    href: 'https://docs.swetrix.com/squarespace-integration',
    icon: siSquarespace,
    iconClassName: 'dark:text-white',
  },
  {
    name: 'SvelteKit',
    category: 'framework',
    href: 'https://docs.swetrix.com/sveltekit-integration',
    icon: siSvelte,
  },
  {
    name: 'Vue',
    category: 'framework',
    href: 'https://docs.swetrix.com/vue-integration',
    icon: siVuedotjs,
  },
  {
    name: 'Webflow',
    category: 'cms',
    href: 'https://docs.swetrix.com/webflow-integration',
    icon: siWebflow,
  },
  {
    name: 'Wix',
    category: 'cms',
    href: 'https://docs.swetrix.com/wix-integration',
    icon: siWix,
  },
  {
    name: 'WooCommerce',
    category: 'cms',
    href: 'https://docs.swetrix.com/woocommerce-integration',
    icon: siWoocommerce,
  },
  {
    name: 'WordPress',
    category: 'cms',
    href: 'https://docs.swetrix.com/wordpress-integration',
    icon: siWordpress,
  },
]
