const GoogleSearchConsoleSVG = ({ className }: { className?: string }) => (
  <svg className={className} viewBox='6.239 2.66350997 503.09749003 503.10849003'>
    <g fill='none'>
      <path
...
export default GoogleSearchConsoleSVG
