  ...
  <Field disabled={disabled}>
    <div className={cx('flex items-center gap-2', classes?.label)}>
      <HeadlessCheckbox
        ...
        checked={checked}
        onChange={onChange}
        className='group size-4 shrink-0 cursor-pointer rounded-sm bg-white ring-1 ring-gray-200 ring-inset data-[checked]:bg-slate-900 data-[checked]:ring-slate-900 dark:bg-white/10 dark:ring-white/15 dark:data-[checked]:bg-white dark:data-[checked]:ring-white/15'
      >
