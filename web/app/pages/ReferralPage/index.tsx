              ...
              <div className='relative px-4 text-left lg:mt-0 lg:mr-14'>
                ...
                <div className='mt-4 flex flex-col items-center sm:flex-row'>
                  ...
                  <Link
                    ...
                    className='mt-2 flex h-12 w-full items-center justify-center rounded-md bg-transparent text-slate-900 ring-1 ring-slate-900 transition-all hover:bg-slate-200/60 sm:mt-0 sm:max-w-[210px] dark:text-white dark:ring-white/20 dark:hover:bg-slate-800/60'
                    aria-label={t('titles.signup')}
                  >
