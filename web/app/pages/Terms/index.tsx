  ...
  return (
    <div className='bg-gray-50 dark:bg-slate-900'>
      <div className='mx-auto w-11/12 px-4 pt-12 pb-16 sm:px-6 md:w-4/5 lg:px-8'>
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Acknowledgment</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          <br />
          Your access to and use of the Service is also conditioned on your acceptance of and compliance with our
          Privacy Policy. Our Privacy Policy describes our policies and procedures on the collection, use and disclosure
          of your personal information when you access our websites or use our Service and tells you about your privacy
          rights and how the law protects you. Please read Our Privacy Policy carefully before using our Service.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Eligibility</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Indemnity</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          expenses, including reasonable attorneys' fees and costs, arising out of or in any way connected with (i) your
          access to, use of, or alleged use of the Service; (ii) your violation of these Terms or any representation,
          ...
          property or privacy right; or (iv) any disputes or issues between you and any third party. We reserve the
          right, at our own expense, to assume the exclusive defense and control of any matter otherwise subject to
          indemnification by you (and without limiting your indemnification obligations with respect to such matter),
          and in such case, you agree to cooperate with our defense of such claim.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Termination</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          notice to you. We will have no liability whatsoever on account of any change to the Service or any suspension
          or termination of your access to or use of the Service.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Fair use</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          shut down and terminate our Service if your usage is creating an unreasonable burden on our infrastructure
          and/or business operations.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Third-party websites</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          third party websites or services. You further acknowledge and agree that the Company shall not be responsible
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>License grant to us</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          incorporate, exploit, display, perform, reproduce, distribute, and prepare derivative works of your Content.
          You will retain ownership of your Content, however, any use of your Content by us may be without any
          compensation paid to you. By submitting, posting, and publishing your Content, you represent and warrant that
          your Content, does not: (i) infringe, violate, or misappropriate any third-party right, including any
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Prohibited uses</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          could interfere with any other party's use and enjoyment of any Service. You may not transmit any viruses,
          worms, defects, Trojan horses, or any items of a destructive nature through your use of Service. You may not
          exceed or circumvent, or try to exceed or circumvent, limitations on the Service, including on any API calls,
          or otherwise use the Service in a manner that violates any Swetrix documentation or user manuals. You may not
          attempt to gain unauthorized access to any Service, other accounts, computer systems, or networks connected to
          any Swetrix server or to any of the Service through hacking, password mining, or any other means. You may not
          obtain or attempt to obtain any materials or information through any means not intentionally made available
          through the Service. You may not use the Service in any way that violates any applicable federal, state,
          local, or international law or regulation (including, without limitation, any laws regarding the export of
          data or software to and from the US or other countries).
          <br />
          Our Service is not intended for providing alerts on disaster scenarios or any other situations related to
          health or safety in any way. This includes but is not limited to natural disasters, acts of terrorism, or
          emergency responses, and you shall not use our Service for any such purposes.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Limitation of liability</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE), STATUTE, OR ANY OTHER LEGAL THEORY, WHETHER OR NOT THE
          COMPANY ENTITIES HAVE BEEN INFORMED OF THE POSSIBILITY OF SUCH DAMAGE.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Disclaimers; no warranties</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          CLAIMS OR PROMISES ABOUT THE QUALITY, ACCURACY, OR RELIABILITY OF THE SERVICE AND EXPRESSLY DISCLAIM ALL
          WARRANTIES, WHETHER EXPRESS OR IMPLIED, INCLUDING IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A
          PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Accounts</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Subscriptions</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          shall provide us with accurate and complete billing information including full name, address, state, zip code,
          telephone number, and a valid payment method information. By submitting such payment information, you
          automatically authorize us to charge all Subscription fees incurred through your account to any such payment
          instruments.
          <br />
          Should automatic billing fail to occur for any reason, we may issue an electronic invoice indicating that you
          must proceed manually, within a certain deadline date, with the full payment corresponding to the billing
          period as indicated on the invoice.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Fee changes</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          <br />
          We will provide you with a reasonable prior notice of any change in Subscription fees to give you an
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Refunds</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          ...
          <br />
          Except when required by law, paid Subscription fees are non-refundable. However, you may contact our support
          team and at our sole discretion we may issue a refund on a case-by-case basis.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Governing Law</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Disputes resolution</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
          If you have any concern or dispute about the Service, you agree to first try to resolve the dispute informally
          by contacting the Company.
        </p>

        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>For European Union (EU) users</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>United States Legal Compliance</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Severability</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Waiver</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Translation interpretation</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
        ...
        <h3 className='mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50'>Contact us</h3>
        <p className='text-md text-gray-900 dark:text-gray-50'>
