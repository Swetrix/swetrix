...
const SetupTrackingStep = ({
  ...
  return (
    <div>
      ...
      {/* Tabs */}
      <div className='mb-4 flex gap-1 rounded-lg bg-gray-100 p-1 dark:bg-slate-800'>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-white text-gray-900 ring-1 ring-gray-200 ring-inset dark:bg-slate-700 dark:text-gray-100 dark:ring-slate-800'
      ...
      <div className='rounded-xl border border-gray-200 bg-gray-50 p-5 dark:border-slate-700 dark:bg-slate-950'>
        {activeTab === 'script' && (
          <div>
            ...
            <CodeBlock code={getSnippet(project.id)} />
          </div>
        )}
          ...
          <div>
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <CodeBlock code={getNpmSnippet(project.id)} />
              </div>
            </div>
          ...
          <div>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <CopyableField value={project.id} />
              </div>
              ...
              <div>
                ...
                <CodeBlock code={getGtmSnippet(project.id)} />
              </div>
