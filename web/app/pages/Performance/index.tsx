  ...
  return (
    <div className='mx-auto w-full max-w-5xl px-3'>
      <div className='mx-auto w-full max-w-prose'>
        ...
        <p className='mx-auto mt-5 max-w-prose text-center font-mono text-xl text-gray-600 dark:text-gray-200'>
          {t('main.whyPeopleLoveSwetrix')}
        </p>
      </div>
      <div className='mt-20 flex flex-col items-center justify-between font-mono md:mt-32 md:flex-row'>
    ...
    <div className='overflow-hidden'>
      <main className='bg-white dark:bg-slate-900'>
        ...
        <div className='mx-auto mt-12 max-w-7xl bg-white px-4 pb-16 whitespace-pre-line dark:bg-slate-900'>
          ...
          <p className='mt-6 font-mono text-lg text-gray-900 dark:text-gray-50'>{t('performance.metrics.desc')}</p>
