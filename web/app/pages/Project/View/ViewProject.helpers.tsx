  ...
  return {
    ...
    tooltip: {
      contents: (item, _, __, color) => {
        ...
        if (_isEmpty(compareChart)) {
          return `<ul class='bg-gray-100 dark:text-gray-50 dark:bg-slate-800 rounded-md ring-1 ring-black/10 px-3 py-1'>
        ...
        return `
        <ul class='bg-gray-100 dark:text-gray-50 dark:bg-slate-800 rounded-md ring-1 ring-black/10 px-3 py-1'>
          ${_map(item, (el: { id: string; index: number; name: string; value: string; x: Date }) => {
  ...
  return {
    ...
    tooltip: {
      contents: (items: any, _: any, __: any, color: any) => {
        ...
        return `
          <div class='bg-gray-100 dark:text-gray-50 dark:bg-slate-800 rounded-md ring-1 ring-black/10 px-3 py-1'>
            ${title}
            <hr class='border-gray-200 dark:border-gray-600' />
