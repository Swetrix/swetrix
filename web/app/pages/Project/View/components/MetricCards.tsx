    ...
    <div className={cx('flex flex-col', classes?.container)}>
      ...
      <div className='relative flex items-center text-sm font-bold whitespace-nowrap'>
        <OutsideClickHandler onOutsideClick={() => setShow(false)}>
          ...
          {show && (
            <div className='absolute top-15 z-10 mt-2 max-h-[200px] min-w-[250px] overflow-auto rounded-md border border-gray-200 bg-white text-gray-900 shadow-lg dark:border-slate-700/50 dark:bg-slate-900'>
