import { ChartColumnBigIcon, ChartLineIcon } from 'lucide-react'
  ...
  if (type === chartTypes.bar) {
    return (
      <button
        ...
        className='rounded-md border border-transparent p-1.5 text-sm font-medium transition-colors ring-inset hover:border-gray-300 hover:bg-white focus:z-10 focus:ring-1 focus:ring-indigo-500 focus:outline-hidden hover:dark:border-slate-700/80 hover:dark:bg-slate-900 focus:dark:ring-gray-200'
      >
