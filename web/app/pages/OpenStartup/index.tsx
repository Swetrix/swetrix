...
const financeData = {
  ...
  '2024-04-01': {
    'Technical Expences': -23,
    'Business Expences': -255, // google ads campaign
    MRR: 148,
    Revenue: 1536,
  },
  '2024-05-01': {
  ...
  '2024-08-01': {
    'Technical Expences': -45,
    'Business Expences': -898, // marketing + marketing freelancer
    MRR: 204,
    Revenue: 781,
  },
  '2024-09-01': {
    'Technical Expences': -69,
    'Business Expences': -1005, // marketing + marketing freelancer
    MRR: 214,
    Revenue: 818,
  },
  '2024-10-01': {
    'Technical Expences': -75, // cloud hosting, mail
    'Business Expences': -1148, // google ads + marketing freelancer
    MRR: 238,
    Revenue: 6378,
  },
}
...
const financeDataToColumns = (financeData: any) => {
  ...
  const columns = [['Technical Expences'], ['Business Expences'], ['MRR'], ['Profit'], ['Revenue'], ['x']]
