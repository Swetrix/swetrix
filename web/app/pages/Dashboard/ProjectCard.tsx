...
export const ProjectCard = ({
  ...
  return (
    <Link
      ...
      className={cx(
        'group relative cursor-pointer overflow-hidden rounded-xl border border-gray-200 bg-gray-50 transition-colors hover:bg-gray-200/70 dark:border-slate-800/60 dark:bg-slate-900/25 dark:hover:bg-slate-900',
        viewMode === 'list'
