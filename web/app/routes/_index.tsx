          ...
          <div className='flex w-full flex-col items-center'>
            ...
            <div className='mt-8 flex w-full flex-col items-stretch justify-center gap-3 sm:w-auto sm:flex-row sm:items-center'>
              ...
              <Button
                ...
                variant='secondary'
                size='xl'
                className='h-12 items-center border-white/25 bg-white/10 px-5 text-center text-base font-semibold text-white shadow-none ring-white/25 backdrop-blur-md hover:bg-white/20 dark:border-white/25 dark:bg-white/10 dark:text-white dark:hover:bg-white/20'
                aria-label={`${t('main.seeLiveDemo')} (opens in a new tab)`}
              >
                {t('common.liveDemo')}
              </Button>
