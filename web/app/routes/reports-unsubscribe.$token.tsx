...
export const meta: MetaFunction = () => {
  ...
  return [
    ...
    ...getPreviewImage(
      getOgImageUrl(t('titles.unsubscribe'), t('description.default')),
    ),
  ]
}
...
export async function loader({
  ...
  const result = await serverFetch(request, `user/unsubscribe/${token}`, {
    skipAuth: true,
  })
...
export default function ReportsUnsubscribeRoute() {
