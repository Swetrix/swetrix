...
- **Session replays (Cloud)**: replay user sessions to investigate UX issues and understand where visitors get stuck.
...
| **Session replays**                                                          | ✅ Included                                                                                                                                                                       | ⚠️ Cloud only; not included in CE                                                                                                                               |
