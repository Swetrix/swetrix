...
describe('Tooltip', () => {
  it('should render the tooltip text when hovering over the icon', () => {
    ...
    const { getByTestId, getByText } = render(<Tooltip text={text} />)
  ...
  it('should render a custom tooltip icon when provided', () => {
    ...
    const { getByTestId } = render(<Tooltip tooltipNode={<CustomIcon />} text='dds' />)
  ...
  it('should render a custom class name when provided', () => {
    ...
    const { getByTestId } = render(<Tooltip text='Tooltip' className={className} />)
