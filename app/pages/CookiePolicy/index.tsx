  ...
  return (
    <div className='bg-gray-50 dark:bg-slate-900'>
      <div className='mx-auto w-11/12 px-4 pb-16 pt-12 sm:px-6 md:w-4/5 lg:px-8'>
        ...
        <h3 className='mt-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-50'>What is a cookie?</h3>
        ...
        <div className='text-lg tracking-tight text-gray-900 dark:text-gray-50'>
