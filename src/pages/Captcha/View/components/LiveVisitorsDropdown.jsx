...
const LiveVisitorsDropdown = ({ live, projectId }) => {
  ...
  return (
    ...
    >
      ...
      {show && (
        <div className='absolute z-10 mt-2 right-0 top-20 text-gray-900 bg-white border border-gray-200 rounded-md shadow-lg dark:bg-gray-800 dark:border-gray-700 min-w-[250px] max-h-[200px] overflow-auto'>
