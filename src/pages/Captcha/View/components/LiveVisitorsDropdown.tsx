...
const LiveVisitorsDropdown = ({ live, projectId }: {
  ...
  return (
    ...
    >
      ...
      {show && (
        <div className='absolute z-10 mt-2 right-0 top-20 text-gray-900 bg-white border border-gray-200 rounded-md shadow-lg dark:bg-slate-900 dark:border-gray-700 min-w-[250px] max-h-[200px] overflow-auto'>
          ...
          <XMarkIcon className='absolute rounded-md top-2 right-2 w-5 h-5 text-gray-900 cursor-pointer dark:text-gray-50 hover:bg-gray-200 hover:dark:bg-slate-800 ' onClick={() => setShow(!show)} />
        </div>
      )}
    </OutsideClickHandler>
  )
