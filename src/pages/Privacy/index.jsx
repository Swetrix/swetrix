    ...
    <Title title='Privacy Policy'>
      <div className='bg-gray-50'>
        <div className='w-11/12 md:w-4/5 mx-auto pb-16 pt-12 px-4 sm:px-6 lg:px-8'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>1. Policy application</h3>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>2. Information we collect</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>3. How we use information we collect</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>4. UK and EU residents</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>5. California Residents</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>6. Retention of data</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>7. Transfer of data</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>8. Information sharing</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>9. Data subject rights</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>10. Communication preferences</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>11. Data security</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>12. Notification of changes</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>13. Business transactions</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>14. Contact</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
