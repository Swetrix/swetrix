    ...
    <Title title='Terms and Conditions'>
      <div className='bg-gray-50'>
        <div className='w-11/12 md:w-4/5 mx-auto pb-16 pt-12 px-4 sm:px-6 lg:px-8'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Acknowledgment</h3>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Eligibility</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Indemnity</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Termination</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>License grant to us</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Prohibited uses</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Limitation of liability</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Disclaimers; no warranties</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Accounts</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Subscriptions</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Fee changes</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Refunds</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Governing Law</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Disputes resolution</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
            If you have any concern or dispute about the Service, you agree to first try to resolve the dispute informally by contacting the Company.
          </p>

          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>For European Union (EU) users</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
            If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.
          </p>

          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>United States Legal Compliance</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
            You represent and warrant that (i) you are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.
          </p>

          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Severability</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
            If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
          </p>

          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Waiver</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
            Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Agreement shall not affect a party’s ability to exercise such right or require such performance at any time thereafter, nor shall the waiver of a breach constitute the waiver of any subsequent breach.
          </p>


          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Translation interpretation</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
            These Terms and Conditions may have been translated if we have made them available to you on our Service. You agree that the original English text shall prevail in the case of a dispute.
          </p>

          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Changes to these Terms and Conditions</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 tracking-tight mt-4'>Contact us</h3>
          <p className='text-lg text-gray-900 tracking-tight'>
