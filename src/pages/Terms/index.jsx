    ...
    <Title title='Terms and Conditions'>
      <div className='bg-gray-50 dark:bg-gray-800'>
        <div className='w-11/12 md:w-4/5 mx-auto pb-16 pt-12 px-4 sm:px-6 lg:px-8'>
          <h1 className='text-4xl font-bold text-gray-900 dark:text-gray-50 tracking-tight'>Swetrix Terms and Conditions</h1>
          ...
          <h3 className='text-2xl font-bold text-gray-900 dark:text-gray-50 tracking-tight mt-4'>Disclaimers; no warranties</h3>
          <p className='text-lg text-gray-900 dark:text-gray-50 tracking-tight'>
          ...
          <h3 className='text-2xl font-bold text-gray-900 dark:text-gray-50 tracking-tight mt-4'>For European Union (EU) users</h3>
          <p className='text-lg text-gray-900 dark:text-gray-50 tracking-tight'>
            If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.
          </p>

          <h3 className='text-2xl font-bold text-gray-900 dark:text-gray-50 tracking-tight mt-4'>United States Legal Compliance</h3>
          <p className='text-lg text-gray-900 dark:text-gray-50 tracking-tight'>
