  ...
  <Menu as='div' className={cx('relative inline-block text-left', className)}>
    {({ open }) => (
      <>
        ...
        >
          <Menu.Items static className='z-10 origin-top-right absolute right-0 mt-2 min-w-max rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 focus:outline-none'>
            <div className='py-1'>
              {_map(items, item => (
