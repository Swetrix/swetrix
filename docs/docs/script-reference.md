...
| apiURL     | If you use Swetrix Cloud, you don't need to change this parameter. If you're self-hosting Swetrix CE, you should put the URL of your API instance here, like `[BASE_URL]/backend/v1/log`.                                                                                                                                                                                                 | `'https://api.swetrix.com/log'` |
...
| Name   | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Default value      |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| ev     | The event identifier you want to track. Can contain any characters (including spaces, unicode, etc.) with a maximum length of 256 characters.                                                                                                                                                                                                                                                                                                                                                                       | REQUIRED PARAMETER |
