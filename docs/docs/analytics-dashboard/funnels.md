...
<img alt="Funnel view" src={useBaseUrl('img/analytics-dashboard/funnel-view.png')} />
...
<img alt="Create a funnel" src={useBaseUrl('img/analytics-dashboard/create-funnel.png')} />
