...
<img alt="Alerts Dashboard" src={useBaseUrl('img/analytics-dashboard/alerts-list.png')} />
...
<img alt="Alert communication channels" src={useBaseUrl('img/accountsettings/communication-channels.png')} />
...
<img alt="Create an alert" src={useBaseUrl('img/analytics-dashboard/create-an-alert.png')} />
