...
const SLUG_MAP: Record<string, string[]> = {
  ...
  "sitesettings/how-to-invite-users-to-your-website": ["how-to-invite-users-to-your-website"],
  ...
  // Billing → flat URLs
  "billing/upgrade-from-trial": ["upgrade-from-trial-to-a-paid-subscription"],
