...
description: "Integrate Swetrix with Fastify using this installation guide. Add privacy-friendly website analytics and verify that tracking works."
---

Integrate Swetrix with your [Fastify](https://fastify.dev/) application using the [`@swetrix/node`](https://github.com/Swetrix/swetrix/tree/main/packages/tracker-node) server-side SDK to track page views, monitor errors, and capture custom events — all while staying privacy-friendly and GDPR-compliant.
