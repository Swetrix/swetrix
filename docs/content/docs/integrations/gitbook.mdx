...
description: "Integrate Swetrix with GitBook using this installation guide. Add privacy-friendly website analytics and verify that tracking works."
---
...
<Callout type="warn">
Don't forget to replace `YOUR_PROJECT_ID` with your actual Project ID from the [Swetrix dashboard](https://swetrix.com/dashboard), otherwise tracking won't work.
