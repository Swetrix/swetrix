...
description: "Integrate Swetrix with Google Tag Manager using this installation guide. Add privacy-friendly website analytics and verify that tracking works."
---
...
1. Sign in to your Google Tag Manager account, click on **Tags** and then **New**.
   ...
   <img alt="Creating a new tag" src="/docs/img/integrations/google/gt-1.png" />

2. Under the **Tag Configuration** section, click on "Choose a tag type to begin set-up...".

   <img alt="Tag Configuration" src="/docs/img/integrations/google/gt-2.png" />

3. Select **Custom HTML**.

   <img alt="Custom HTML" src="/docs/img/integrations/google/gt-3.png" />
...
6. Give your tag a name — change "Untitled Tag" to something like **Swetrix Analytics**. The result should look similar to this:
   ...
   <img alt="Final result" src="/docs/img/integrations/google/gt-4.png" />
...
7. Click **Save**. A list of tags will be displayed - you should see your new Swetrix tag in the list. Click the **Submit** button in the top right corner.
   ...
   <img alt="Tags list" src="/docs/img/integrations/google/gt-5.png" />

8. Add a description for your changes in the pop-up window and click **Publish**.
   <img alt="Publish" src="/docs/img/integrations/google/gt-6.png" />
