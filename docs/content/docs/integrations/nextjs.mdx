...
description: "Integrate Swetrix with Next.js using this installation guide. Add privacy-friendly website analytics and verify that tracking works."
---
...
<Tabs items={["App Router (recommended)", "Pages Router"]}>
<Tab value="App Router (recommended)">
...
Add to `pages/_document.tsx` inside `<body>`:
