...
description: "Integrate Swetrix with SolidJS / SolidStart using this installation guide. Add privacy-friendly website analytics and verify that tracking works."
---
