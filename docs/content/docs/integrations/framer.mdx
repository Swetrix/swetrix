...
description: "Integrate Swetrix with Framer using this installation guide. Add privacy-friendly website analytics and verify that tracking works."
---
...
2. In the dashboard, click on the website you want to add Swetrix to:
   ...
   <img alt="Framer Dashboard" src="/docs/img/framer-1.png" />

3. Open the website settings:

   <img alt="Framer Website page" src="/docs/img/framer-2.png" />

4. Scroll down to the `Custom Code` section:

   <img alt="Framer Website page" src="/docs/img/framer-3.png" />
