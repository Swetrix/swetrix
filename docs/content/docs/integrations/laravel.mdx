...
description: "Integrate Swetrix with Laravel using this installation guide. Add privacy-friendly website analytics and verify that tracking works."
---
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js']) {{-- Swetrix Analytics --}}
    <script src="https://swetrix.org/swetrix.js" defer></script>
  </head>
  <body>
    @yield('content') {{-- Swetrix Analytics --}}
    <script>
