...
description: "Integrate Swetrix with Webflow using this installation guide. Add privacy-friendly website analytics and verify that tracking works."
---
...
2. Open up your project, go to the `Project Settings > Custom Code` section:
   ...
   <img alt="Webflow screenshot" src="/docs/img/webflow-int.png" />
