...
description: "Integrate Swetrix with Astro using this installation guide. Add privacy-friendly website analytics and verify that tracking works."
---
...
<Tabs items={["CDN script (recommended)", "npm package"]}>
<Tab value="CDN script (recommended)">
...
<Tabs items={["CDN script", "npm package"]}>
<Tab value="CDN script">

Wrap the initialisation in a host check:
