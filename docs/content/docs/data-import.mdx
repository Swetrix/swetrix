...
Unlike file-based imports, Google Analytics 4 (GA4) import works by connecting your Google account directly. Swetrix uses the GA4 Data API to pull your historical analytics data automatically.
...
### What data is imported from GA4?
...
- **GA4 dimensions**: Google Analytics 4 imports are subject to API limitations — see the [GA4 section](#what-s-not-imported) for details
