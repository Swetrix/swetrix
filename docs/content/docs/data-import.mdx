...
Make sure you're uploading the correct file format for your provider. For Umami, upload the `.zip` file directly - do not extract it first. For Simple Analytics, upload the `.csv` export file.
