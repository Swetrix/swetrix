...
<Callout type="info">
  GA4 imports use aggregated data from Google's API. Some dimensions like language, region, city,
  browser/OS versions, and UTM campaign/term/content are not available due to API limitations.
  Data is imported with hourly precision.
</Callout>
