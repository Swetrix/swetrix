...
slug: /integrations
description: "Find step-by-step Swetrix installation guides for website builders, CMS platforms, frontend frameworks, and backend applications."
---
...
- [Flutter / Dart SDK](https://pub.dev/packages/swetrix_flutter) — lightweight client for tracking page views, events, errors, and feature flags in Flutter apps
- [Java SDK](https://github.com/Casterlabs/swetrix-java)
- [Railway](/selfhosting/how-to#railway) — one-click template for deploying Swetrix Community Edition on Railway
