...
| Data type | Metrics |
| --- | --- |
| traffic | `visitors` (unique sessions), `pageviews`, `users` (unique profiles; breakdown/summary only), `session_duration` (timeseries/summary only), `bounce_rate` (timeseries/summary only) |
...
{
  "data": {
    "current": { "visitors": 1043, "pageviews": 2911, "users": 402, "bounce_rate": 43.1, "session_duration": 74 },
    "previous": { "visitors": 980, "pageviews": 2700, "users": 371, "bounce_rate": 45, "session_duration": 69 },
    "change": { "visitors": 63, "pageviews": 211, "users": 31, "bounce_rate": -1.9, "session_duration": 5 }
  },
...
Parameters: `period`/`from`+`to`, `timezone`, `timeBucket` (optional), `metrics` (default `visitors,pageviews`; also `session_duration`, `bounce_rate`), `mode` (`periodical` default, or `cumulative`), `filters`.
...
{
  "data": [
    { "timestamp": "2026-07-01T00:00:00+03:00", "visitors": 120, "pageviews": 340, "bounce_rate": 41.2 },
    { "timestamp": "2026-07-02T00:00:00+03:00", "visitors": 98, "pageviews": 275, "bounce_rate": 44 }
  ],
  "meta": {
    "pid": "YOUR_PROJECT_ID",
    "period": "7d",
...
{
  "data": [
    { "value": "Kyiv City", "country": "UA", "region_code": "30", "visitors": 512, "pageviews": 1204 },
...
### GET /v2/projects/:pid/traffic/user-flow

Page-to-page navigation flows: `data: { "ascending": { "nodes": [...], "links": [...] }, "descending": { ... } }`.
...
```json title="Response"
{
  "data": {
    "count": 2,
    "visitors": [
      { "device": "desktop", "browser": "Firefox", "os": "Windows", "country": "GB", "psid": "9165978030580383830" }
    ]
  },
...
{
  "dimensions": [
    { "name": "country", "description": "Country (ISO 3166-1 alpha-2 code)", "filterOnly": false, "extraFields": [] },
    { "name": "region", "description": "Region / subdivision", "filterOnly": false, "extraFields": ["country", "region_code"] }
  ],
  "metrics": [
...
| `GET /v1/log/user-flow` | `/traffic/user-flow` |
