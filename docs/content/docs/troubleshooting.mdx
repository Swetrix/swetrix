...
icon: Wrench
description: "Troubleshoot missing Swetrix pageviews, blocked tracking requests, script installation errors, and other common integration problems."
---
...
<img alt="Browser Network tab" src="/docs/img/swetrix-network-tab.png" />
