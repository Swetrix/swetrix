...
description: "Change your Swetrix account password or reset a forgotten password to regain access to your website analytics securely."
---
...
Open the "Password and sign-in" tab and find the "Change password" section.

Enter your current password and your new password, then click the "Update password" button. This logs you out of Swetrix on every device, including this one. You will need to sign in again with your new password.
