...
description: "Learn how to delete your Swetrix account and review the consequences for your projects and analytics data before proceeding."
---
...
Make sure you unsubscribed from the paid subscription if you have one. You can do this on the [Plan and billing page](https://swetrix.com/user-settings?tab=billing).
