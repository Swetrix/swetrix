...
To change your subscription plan, log into your account and go to the [Billing](https://swetrix.com/user-settings?tab=billing) page. There you will find a subscription selector that allows you to choose a plan based on how much traffic your site has.
