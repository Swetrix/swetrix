...
description: "Create and apply segments in Swetrix to compare groups of visitors and focus your analytics on relevant traffic and behaviour."
---
...
<img alt="Segments Modal" src="/docs/img/analytics-dashboard/segments.png" />
