...
description: "Create and manage feature flags in Swetrix to control feature rollouts and target the visitors who receive each experience."
---
...
<Callout type="info">
  On Swetrix Cloud, Feature Flags are available on Plus and Enterprise plans. Self-hosted instances
