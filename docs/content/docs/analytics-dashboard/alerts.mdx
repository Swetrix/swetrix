...
<img alt="Alerts Dashboard" src="/img/analytics-dashboard/alerts-list.png" />
...
<img alt="Alert communication channels" src="/img/accountsettings/communication-channels.png" />
...
<img alt="Create an alert" src="/img/analytics-dashboard/create-an-alert.png" />
