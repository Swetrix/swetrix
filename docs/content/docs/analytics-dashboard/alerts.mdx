...
<img
  alt="Alert communication channels"
  src="/docs/img/accountsettings/communication-channels.png"
/>

## Creating an Alert

1.  Navigate to your project's **Settings** and click on the **Alerts** tab.
...
Once created, your alerts will appear in a list on the Alerts tab in your project settings.
