...
description: "Use Swetrix session replays to investigate visitor interactions, understand usability problems, and diagnose issues in context."
---

<Callout type="info">
  Session replays are available on Swetrix Cloud and Community Edition. For a self-hosted instance,
  first [configure S3-compatible replay storage](/selfhosting/session-replays).
</Callout>
...
<img alt="Session replay" src="/docs/img/analytics-dashboard/session-replay.png" />
