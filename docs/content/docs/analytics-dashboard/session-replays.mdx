...
- `free-love`: only forces password inputs to stay masked unless you add your own recorder masking options.
...
<Callout type="warn">
  Review your privacy policy, consent flow, and masking settings before recording replays on pages
  that may contain personal, financial, health, authentication, or other sensitive data.
</Callout>
