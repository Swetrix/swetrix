...
description: "Build Swetrix funnels to measure each step in a visitor journey, identify drop-offs, and investigate conversion opportunities."
---
...
For every step except the final one, the sessions drawer can be switched to show only drop-offs: sessions that reached the selected step but did not continue to the next step.
