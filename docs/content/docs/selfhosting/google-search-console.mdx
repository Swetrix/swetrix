...
description: "Connect Google Search Console to self-hosted Swetrix to view search queries, impressions, clicks, and rankings alongside website analytics."
---
...
<Callout type="info">
  Already have a Google Cloud project with an OAuth consent screen and a verified Search Console
  property? Skip to [Issue an OAuth client](#issue-an-oauth-client-and-secret).
</Callout>
