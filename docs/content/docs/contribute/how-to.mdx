...
slug: /contribute
description: "Contribute to Swetrix by reporting bugs, suggesting improvements, or helping develop its open-source analytics tools and documentation."
---
...
<Callout type="info">
  All Swetrix repositories are open source and available on [GitHub](https://github.com/Swetrix). We
  welcome contributions of all kinds — from code to translations to documentation.
</Callout>
