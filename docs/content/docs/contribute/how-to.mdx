...
<Callout type="info">
All Swetrix repositories are open source and available on [GitHub](https://github.com/Swetrix). We welcome contributions of all kinds — from code to translations to documentation.
</Callout>
