...
<Callout type="warn">
  ...
  depending on the privacy mode you choose. Do not record sensitive pages unless you have reviewed
...
| Name              | Description                                                                                                                                                                                                                                                 | Default value |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| privacy           | Controls how much page content is masked. Use `total` to mask all text and inputs and block media/canvas content, `normal` to mask all inputs, or `free-love` to only force password inputs to stay masked unless you add your own `rrweb` masking options. | `normal`      |
