...
This ID is commonly used for [revenue attribution](/analytics-dashboard/revenue-tracking#user-attribution) — pass it as `swetrix_profile_id` in your payment provider's metadata to link transactions to specific visitors.
