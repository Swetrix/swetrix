...
description: "Validate Swetrix CAPTCHA tokens on your server before accepting form submissions or other requests that need bot protection."
---
...
<TabsList>
  <TabsTrigger value="http"><HttpRequestIcon /> HTTP request</TabsTrigger>
  <TabsTrigger value="node"><NodeIcon /> Node.js library</TabsTrigger>
</TabsList>
...
curl -X POST\
  ...
  https://api.swetrixcaptcha.com/v1/captcha/validate
```
