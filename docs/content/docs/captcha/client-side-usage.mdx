...
description: "Add Swetrix CAPTCHA to your website, configure the client widget, and pass verification tokens to your server for validation."
---
...
Then import it in your browser bundle:

```javascript
import "@swetrix/captcha";
```

The package automatically renders `.swecaptcha` elements when the DOM is ready. If you render the widget after the initial page load, you can call:
...
| `data-asset-url`           | string | The URL where the CAPTCHA package assets are hosted. Default: `https://cdn.swetrixcaptcha.com/dist/`.                                                                                                                                                   |
